...
public class AStarTest
{
	...
	public void test()
	{
		...
		assertTrue(cities.add(new City("Detroit", 0, 0, 0)));
		assertTrue(cities.add(new City("Chicago", 0, 1, 1)));
		assertTrue(cities.add(new City("New York", 0, 1, 2)));
...
//				new Connection(cities.get(1).distanceTo(cities.get(2)))));
//		
//		System.out.println(pathfinder.findShortestPathBetween(
//				cities.get(0).getName(), cities.get(1).getName()).toString());
//	}
