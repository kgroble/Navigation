...
//	}
	...
	public void stressTest()
	{
		...
		for (int i = 0; i < 100; i++)
		{
			...
			distPath = pathfinder.findShortestPathBetween(start.getName(), end.getName());
			timePath = pathfinder.findFastestPath(start.getName(), end.getName());
			...
			assertTrue(distPath.getPathTravelTime() >= timePath.getPathTravelTime());
		}
	}
